...
const Toy = () => {
    ...
    useEffect(() => {
        async function getProducts() {
            setLoading(true);
            await getDocs(collection(db, 'Toys')).then((snapshot) => {
            ...
            {products && (
                <>
                    <div className='h-72 md:h-96 relative bg-center bg-cover'>
                        ...
                        />
                        <h1 className='absolute w-full text-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-5xl font-extrabold'>Cat Toys</h1>
                    </div>
                    <div className='px-10'>
