    ...
    return (
        <>
            ...
            <div className="ml-9 w-48 flex float-right justify-between">
                ...
                <Link href='/account'>
                    <a><FontAwesomeIcon icon={faUser} className="text-4xl text-accent" title="Profile" /></a>
                </Link>

                <Link href='/'>
                    <a>
                        <FontAwesomeIcon icon={faMagnifyingGlass} className="text-4xl text-accent" title="Search" />
                    </a>
                </Link>

                <button onClick={() => props.setToggleCart()}>
                    <span className="fa-layers fa-fw fa-lg mt-2">
                        <FontAwesomeIcon icon={faCartShopping} className="text-4xl text-accent" title="Cart" />
